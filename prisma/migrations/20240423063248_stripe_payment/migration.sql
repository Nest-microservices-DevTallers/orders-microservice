/*
  ...
  - You are about to drop the column `receiptURL` on the `OrderReceipt` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "OrderReceipt" DROP COLUMN "receiptURL",
